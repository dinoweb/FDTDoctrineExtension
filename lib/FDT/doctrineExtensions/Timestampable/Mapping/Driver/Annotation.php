...
namespace FDT\doctrineExtensions\Timestampable\Mapping\Driver;
...
class Annotation implements Driver
{
     ...
     */
    const ANNOTATION_TIMESTAMPABLE = 'FDT\\doctrineExtensions\\Timestampable\\Mapping\\Timestampable';
